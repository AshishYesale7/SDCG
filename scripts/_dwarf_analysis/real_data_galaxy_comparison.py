...
def main():
    ...
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / 'real_data_galaxy_comparison.pdf', dpi=300, bbox_inches='tight')
    plt.savefig(PLOTS_DIR / 'real_data_galaxy_comparison.png', dpi=300, bbox_inches='tight')
    print(f"  Saved: {PLOTS_DIR / 'real_data_galaxy_comparison.pdf'}")
    ...
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / 'environment_velocity_gradient.pdf', dpi=300, bbox_inches='tight')
    plt.savefig(PLOTS_DIR / 'environment_velocity_gradient.png', dpi=300, bbox_inches='tight')
    print(f"  Saved: {PLOTS_DIR / 'environment_velocity_gradient.pdf'}")
