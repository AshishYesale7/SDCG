...
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'plots', 'stripping_analysis')
...
def main():
    ...
    print()
    print("="*70)
    print("Analysis complete! Check plots/stripping_analysis/ for outputs.")
    print("="*70)
