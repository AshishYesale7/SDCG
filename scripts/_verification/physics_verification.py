...
# Thesis v12: μ_eff(void) = 0.149 = μ_fit × S_avg (μ_fit = 0.47)
mu_eff_void = 0.149
delta_a_sdcg = a_gravity * mu_eff_void * 0.77  # 0.77 = |S_high - S_low|

print(f"   SDCG signal calculation (μ_eff(void)={mu_eff_void}):")
