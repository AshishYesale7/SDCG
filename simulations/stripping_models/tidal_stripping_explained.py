...
plt.tight_layout()
plt.savefig(PLOTS_DIR / 'tidal_stripping_explanation.pdf', dpi=150, bbox_inches='tight')
plt.savefig(PLOTS_DIR / 'tidal_stripping_explanation.png', dpi=150, bbox_inches='tight')
print(f"\n   Saved: {PLOTS_DIR / 'tidal_stripping_explanation.pdf'}")
