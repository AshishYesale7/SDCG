...
def prior_transform_lcdm(u: np.ndarray) -> np.ndarray:
    ...
    # Fix CGC parameters: only μ is sampled, set to 0 for ΛCDM
    theta[6] = 0.0    # μ = 0 (no CGC in ΛCDM)
    # n_g = 0.0125, z_trans = 1.67, ρ_thresh = 200 are FIXED BY THEORY (not in theta)
