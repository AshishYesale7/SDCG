...
% - n_g discrepancy documentation (EFT 0.014 vs MCMC 0.92)
%
% KEY NUMBERS (v3.0):
...
% - n_g = 0.014 (EFT) vs 0.92 (MCMC) - 70× tension!
% - z_trans = 1.67 (EFT)
...
$n_g$ (EFT) & 0.014 & DERIVED & $\beta_0^2/(4\pi^2)$ \\
$n_g$ (MCMC) & $0.92 \pm 0.06$ & FITTED & 70× tension with EFT! \\
...
\textbf{Critical tension:} MCMC-preferred $n_g \approx 0.92$ exceeds EFT bound by factor $\sim 70$!
\end{derivebox}
